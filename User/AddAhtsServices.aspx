<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAhtsServices.aspx.cs" Inherits="Dsportal.User.AddAhtsServices" %>
           ...
           <div id="content">
               ...
               <!-- End of Topbar -->
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Add a Project</h1>
                        ...
                        <div class="col-md-6 offset-md-3 mt-5">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlserviceName" runat="server" class="form-control" OnSelectedIndexChanged="ddlserviceName_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="priceLabel" runat="server" Text="" ForeColor="Red"></asp:Label>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Customer Name:</label>
                                <asp:TextBox ID="customernameTextbox" class="form-control" runat="server" placeholder="Enter Customer Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Customer Mobile No.:</label>
                                <asp:TextBox ID="mobilenumTextbox" class="form-control" runat="server" placeholder="Enter Customers Mobile Number"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Customer E-mail:</label>
                                <asp:TextBox ID="emailTextBox" class="form-control" runat="server" placeholder="Enter Customer's E-mail"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Customer Address:</label>
                                <asp:TextBox ID="addressTextbox" class="form-control" runat="server" placeholder="Enter Address"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Project Requirements:</label>
                                <asp:TextBox ID="requirementTextbox" class="form-control" runat="server" TextMode="MultiLine" Rows="4" Columns="50" placeholder="Enter all requirements you Want"></asp:TextBox>
                            </div>

                            <hr>
                            <div class="form-group mt-3">
                                <label class="mr-2">Upload all files in Zip Format:</label>
