<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AhtsServices.aspx.cs" Inherits="Dsportal.User.AhtsServices" %>
...
<head>
    ...
    <style>
        ...
        .box {
            ...
            .box p {
                background-color: rgba(255, 255, 255, 0.8); /* Semi-transparent white background for better text visibility */
                padding: 10px;
                font-size: 14px;
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">AHTS Services</h1>
