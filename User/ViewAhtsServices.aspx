<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAhtsServices.aspx.cs" Inherits="Dsportal.User.ViewAhtsServices" %>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">View Pending Projects</h1>



                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ID="ViewAhtsServicesGV"
                                runat="server"
                                AutoGenerateColumns="False"
                                DataKeyNames="Project_Id"
                                OnRowCommand="ViewAhtsServicesGV_RowCommand"
                                CssClass="table table-striped">
                                <Columns>
                                    <asp:BoundField DataField="Sl_No" HeaderText="Sl.No." SortExpression="Column1" />
                                    <asp:BoundField DataField="Project_Id" HeaderText="Project Id" SortExpression="Column2" />
                                    <asp:BoundField DataField="Project_Name" HeaderText="Project Name" SortExpression="Column3" />
                                    <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" SortExpression="Column4" />
                                    <asp:BoundField DataField="Customer_Mobile" HeaderText="Mobile No." SortExpression="Column5" />
                                    <asp:BoundField DataField="Project_Requirement" HeaderText="Requirements" SortExpression="Column6" />
                                    <asp:BoundField DataField="Completion_Value" HeaderText="Project Status" SortExpression="Column7" />
                                    <asp:BoundField DataField="Payment_Status" HeaderText="Payment Status" SortExpression="Column7" />

                                    <asp:ButtonField HeaderText="Make Payment" ControlStyle-CssClass="btn btn-info" Text="Click Here" CommandName="Payment" />
