<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CscServices.aspx.cs" Inherits="Dsportal.User.CscServices" %>
...
<head>
    ...
    <title>Digital Seva Services</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Digital Seva Services</h1>
                        ...
                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ...
                                OnRowCommand="CscServicesGV_RowCommand"
                                DataKeyNames="CscService_Id"
                                CssClass="table table-striped">
                                <Columns>
                                    <asp:BoundField DataField="Sl_No" HeaderText="Sl. No." SortExpression="Column1" />
                                    <asp:BoundField DataField="CscService_Id" HeaderText="Service Id" SortExpression="Column2" />
