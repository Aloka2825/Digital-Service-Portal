<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AhtsServiceReport.aspx.cs" Inherits="Dsportal.Admin.AhtsServiceReport" %>
...
<head>
    ...
    <title>Ahts Service Details</title>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="AddAhtsService.aspx">Ahts Services</a>
                            <a class="collapse-item" href="AddCscService.aspx">Digital Services</a>
                            <a class="collapse-item" href="AddOtherService.aspx">Other Online Services</a>
                            <a class="collapse-item" href="AddPopularService.aspx">Popular Services</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="AhtsServiceReport.aspx">Ahts Services</a>
                            <a class="collapse-item" href="CscServiceReport.aspx">Csc Services</a>
                            <a class="collapse-item" href="OtherServiceReport.aspx">Other Services</a>
                            <a class="collapse-item" href="PopularServiceReport.aspx">Popular Services</a>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Ahts Service Details</h1>



                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ID="AhtsServiceReportGV"
                                runat="server"
                                AutoGenerateColumns="False"
                                OnRowDeleting="AhtsServiceReportGV_RowDeleting"
                                OnRowEditing="AhtsServiceReportGV_RowEditing" OnRowUpdating="AhtsServiceReportGV_RowUpdating"
                                DataKeyNames="AhtsService_Id"
                                CssClass="table table-striped">
                                <Columns>
                                    <asp:BoundField DataField="AhtsService_Id" HeaderStyle-CssClass="text-center mat-header-cell cdk-column-position mat-column-position ng-star-inserted" HeaderText="Service ID" SortExpression="Column1" />
                                    <asp:BoundField DataField="Service_Name" HeaderText="Service Name" SortExpression="Column2" />
                                    <asp:BoundField DataField="Department_Name" HeaderText="Department Name" SortExpression="Column3" />
                                    <asp:BoundField DataField="Service_Details" HeaderText="Service Details" SortExpression="Column4" />
                                    <asp:BoundField DataField="Service_Price" HeaderText="Service Price" SortExpression="Column5" />
                                    <asp:BoundField DataField="Service_Photo" HeaderText="Service Photo" SortExpression="Column6" />
                                    <asp:BoundField DataField="Admin_Id" HeaderText="Admin ID" SortExpression="Column7" />
                                    <asp:BoundField DataField="Service_Link" HeaderText="Service URL" SortExpression="Column8" />
                        ...
                        <section id="team1" class="team">
                            <div id="education" class="container" data-aos="fade-up">
                                <div class="row gy-4">

                                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                                        <div class="member">
                                            <a href="http://www.e-learning.ahtscarrier.com">
                                                <img src="forms/elearning.jpg" class="img-fluid" alt="">
