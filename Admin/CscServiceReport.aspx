<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CscServiceReport.aspx.cs" Inherits="Dsportal.Admin.CscServiceReport" %>
...
<head>
    ...
    <title>Digital Seva Service Details</title>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Digital Seva Service Details</h1>
                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ID="CscServiceReportGV"
                                runat="server"
                                AutoGenerateColumns="False"
                                OnRowDeleting="CscServiceReportGV_RowDeleting"
                                OnRowEditing="CscServiceReportGV_RowEditing"
                                OnRowUpdating="CscServiceReportGV_RowUpdating"
                                DataKeyNames="CscService_Id"
                                CssClass="table">
                                <Columns>
                                    <asp:BoundField DataField="CscService_Id" HeaderText="Service ID" SortExpression="Column1" />
