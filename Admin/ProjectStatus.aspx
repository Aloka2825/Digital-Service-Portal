<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectStatus.aspx.cs" Inherits="Dsportal.Admin.ProjectStatus" %>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center; text">Project Report</h1>
                        ...
                        <asp:GridView
                            ID="UserProjectReportGV"
                            runat="server"
                            AutoGenerateColumns="False"
                            OnRowDeleting="UserProjectReportGV_RowDeleting"
                            OnRowEditing="UserProjectReportGV_RowEditing"
                            OnRowUpdating="UserProjectReportGV_RowUpdating"
                            DataKeyNames="Project_Id"
                            CssClass="table">
                            <Columns>
                                <asp:BoundField DataField="Project_Id" HeaderText="Project ID" SortExpression="Column1" />
                                <asp:BoundField DataField="Project_Name" HeaderText="Project Name" SortExpression="Column2" />
                                <asp:BoundField DataField="Completion_Value" HeaderText="Project Status" SortExpression="Column3" />
                                <asp:BoundField DataField="Payment_Status" HeaderText="Payment Status" SortExpression="Column4" />
                                <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" SortExpression="Column5" />
                                <asp:BoundField DataField="Customer_Mobile" HeaderText="Customer Mob. No." SortExpression="Column6" />
                                <asp:BoundField DataField="Project_Requirement" HeaderText="Requirements" SortExpression="Column7" />
