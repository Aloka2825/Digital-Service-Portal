<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopularServiceReport.aspx.cs" Inherits="Dsportal.Admin.PopularServiceReport" %>
...
<head>
    ...
    <title>Popular Service Details</title>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Popular Service Details</h1>
                        <div class="table-responsive gridview-container">
                        <asp:GridView
                            ID="PopularServiceReportGV"
                            runat="server"
                            AutoGenerateColumns="False"
                            OnRowDeleting="PopularServiceReportGV_RowDeleting"
                            OnRowEditing="PopularServiceReportGV_RowEditing"
                            OnRowUpdating="PopularServiceReportGV_RowUpdating"
                            DataKeyNames="PopularService_Id"
                            CssClass="table">
                            <Columns>
                                <asp:BoundField DataField="PopularService_Id" HeaderText="Service ID" SortExpression="Column1" />
                                <asp:BoundField DataField="Service_Name" HeaderText="Service Name" SortExpression="Column2" />
                                <asp:BoundField DataField="Service_Details" HeaderText="Service Details" SortExpression="Column3" />
                                <asp:BoundField DataField="Service_Photo" HeaderText="Service Photo" SortExpression="Column4" />
                                <asp:BoundField DataField="Admin_Id" HeaderText="Admin ID" SortExpression="Column5" />
                                <asp:BoundField DataField="Service_Link" HeaderText="Service URL" SortExpression="Column6" />
