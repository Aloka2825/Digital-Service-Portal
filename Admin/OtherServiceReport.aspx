<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherServiceReport.aspx.cs" Inherits="Dsportal.Admin.OtherServiceReport" %>
...
<head>
    ...
    <title>Other Service Details</title>
    ...
    <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-primary" OnClick="btnSearch_Click">
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Other Online Service Details</h1>
                        <div class="table-responsive gridview-container">
                        <asp:GridView
                            ID="OthServiceReportGV"
                            runat="server"
                            AutoGenerateColumns="False"
                            OnRowDeleting="OthServiceReportGV_RowDeleting"
                            OnRowEditing="OthServiceReportGV_RowEditing"
                            OnRowUpdating="OthServiceReportGV_RowUpdating"
                            DataKeyNames="OthService_Id"
                            CssClass="table">
                            <Columns>
                                <asp:BoundField DataField="OthService_Id" HeaderText="Service ID" SortExpression="Column1" />
