<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FeedbackReport.aspx.cs" Inherits="Dsportal.Admin.FeedbackReport" %>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Feedback Details</h1>
                        ...
                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ...
                                OnRowDeleting="FeedbackReportGV_RowDeleting"
                                DataKeyNames="Feedback_Id"
                                CssClass="table table-striped">
                                <Columns>
                                    <asp:BoundField DataField="Feedback_Id" HeaderStyle-CssClass="text-center mat-header-cell cdk-column-position mat-column-position ng-star-inserted" HeaderText="Feedback ID" SortExpression="Column1" />
                                    <asp:BoundField DataField="Name" HeaderText="Agent Name" SortExpression="Column2" />
                                    <asp:BoundField DataField="Mobile_No" HeaderText="Agent Mobile No." SortExpression="Column3" />
                                    <asp:BoundField DataField="Issue" HeaderText="Issue" SortExpression="Column4" />
                                    <asp:BoundField DataField="User_Id" HeaderText="Agent_Id" SortExpression="Column5" />
