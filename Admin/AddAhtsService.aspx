<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAhtsService.aspx.cs" Inherits="Dsportal.Admin.AddAhtsService" %>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">Add Ahts Service</h1>
                        ...
                        <div class="col-md-6 offset-md-3 mt-5">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="servicenameTextbox" class="form-control" runat="server" placeholder="Enter Service Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputDeptName">Department Name:</label>
                                <asp:TextBox ID="departmentnameTextbox" class="form-control" runat="server" placeholder="Enter Department Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Service Details:</label>
                                <asp:TextBox ID="servicedetailsTextbox" class="form-control" runat="server" placeholder="Enter Service Details"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Service Price:</label>
                                <asp:TextBox ID="servicepriceTextbox" class="form-control" runat="server" placeholder="Enter Service Price"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Admin Id:</label>
                                <asp:TextBox ID="adminidTextbox" class="form-control" runat="server" placeholder="Enter Admin Id"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1" required="required">Service URL:</label>
                                <asp:TextBox ID="serviceUrlTextBox" class="form-control" runat="server" placeholder="Enter Service URL"></asp:TextBox>
                            </div>

                            <hr>
                            <div class="form-group mt-3">
                                <label class="mr-2">Upload Service Photo:</label>
