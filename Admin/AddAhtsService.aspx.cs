...
{
    public partial class AddAhtsService : System.Web.UI.Page
    {
        ...
        {
            if (string.IsNullOrEmpty(servicenameTextbox.Text) || string.IsNullOrEmpty(servicepriceTextbox.Text) || string.IsNullOrEmpty(departmentnameTextbox.Text) || string.IsNullOrEmpty(serviceUrlTextBox.Text) || string.IsNullOrEmpty(servicedetailsTextbox.Text) || string.IsNullOrEmpty(adminidTextbox.Text))
            {
            ...
            else
            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("INSERT INTO [dbo].[tbl_Ahts_Services] (Service_Name, Department_Name, Service_Details, Service_Price, Admin_Id, Service_Photo, Service_Link) VALUES (@ServiceName, @Department, @ServiceDetails, @ServicePrice, @AdminId, @FilePath, @ServiceUrl)", conn))
                        {
