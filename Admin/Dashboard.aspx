<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Dsportal.Admin.Dashboard" %>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">View All Users</h1>
                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ID="UserDetailsGV"
                                runat="server"
                                AutoGenerateColumns="False"
                                OnRowDeleting="UserDetailsGV_RowDeleting"
                                OnRowDataBound="UserDetailsGV_RowDataBound"
                                OnRowCommand="UserDetailsGV_RowCommand"
                                DataKeyNames="Id"
                                CssClass="table">
                                <Columns>
                                    <asp:BoundField DataField="Id" HeaderText="User ID" SortExpression="Column1" />
                                    <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Column2" />
                                    <asp:BoundField DataField="Mob" HeaderText="Mobile No." SortExpression="Column3" />
                                    <asp:BoundField DataField="E_mail" HeaderText="E-mail" SortExpression="Column4" />
                                    <asp:BoundField DataField="Address" HeaderText="Address" SortExpression="Column5" />
                                    <asp:BoundField DataField="Password" HeaderText="Password" SortExpression="Column6" />


                                    <asp:ButtonField HeaderText="Update Project Status" ControlStyle-CssClass="btn btn-info" Text="Update Project Status" CommandName="UpdateProjectStatus" />
