<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectReport.aspx.cs" Inherits="Dsportal.Admin.ProjectReport" %>
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <asp:Literal runat="server" Text=" Search" />
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800" style="text-align: center">All Project Details</h1>
                        <div class="table-responsive gridview-container">
                            <asp:GridView
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="User_Id" HeaderText="Agent Id" SortExpression="Column3" />
                                    <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" SortExpression="Column4" />
                                    <asp:BoundField DataField="Customer_Mobile" HeaderText="Customer Mobile No." SortExpression="Column5" />
                                    <asp:BoundField DataField="Project_File" HeaderText="Project Details" SortExpression="Column6" />
